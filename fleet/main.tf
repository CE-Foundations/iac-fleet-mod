...
locals {
  ...
  fleet_vpn_peer_config_info = flatten([for cluster in var.fleet_vpn_peer_config : [for project in module.control_plane_networking_project : merge(cluster, { project_id = project.project_id })
